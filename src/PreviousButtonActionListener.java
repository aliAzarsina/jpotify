...
public class PreviousButtonActionListener implements ActionListener {
    ...
    public PreviousButtonActionListener(Music music,String musicName,Album album,Mantegh mantegh)
    {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        System.out.println("previousbuttonclicked"+"      "+musicName);
                ...
                if (music.musicName.equals(this.music.musicName)) {
                    if (i == 0) {
                        ...
                        try {
                            ...
                            fileInputStream = new FileInputStream(currentAlbum.musics.get(currentAlbum.musics.size() - 1).musicName);
                            ...
                            pausablePlayer = new PausablePlayer(fileInputStream, mantegh.jpotify, mantegh.jpotify.slider1, mantegh.jpotify.button12, mantegh.jpotify.button13,currentAlbum.musics.get(currentAlbum.musics.size() - 1).musicName);
                            ...
                            changeCurrentMusic(currentAlbum.musics.get(currentAlbum.musics.size() - 1));
                            PreviousButtonActionListener.changeCurrentMusic(currentAlbum.musics.get(currentAlbum.musics.size() - 1));
                            NextMusicRunnable.changeCurrentAlbum(currentAlbum);
                            NextMusicRunnable.musicName=currentAlbum.musics.get(currentAlbum.musics.size() - 1).musicName;
                        } catch (Exception e1) {
                        ...
                        try {
                            ...
                            System.out.println("gggggggggggg"+Mantegh.currentPausableplayer.musicName);
